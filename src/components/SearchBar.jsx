  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        // focus:border-brand-500: red focus ring instead of gray, so
        // typing here visibly ties into the rest of the red theme.
        className="w-full pl-9 pr-3 py-2 text-sm border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 dark:text-white rounded-lg focus:outline-none focus:border-brand-500"
      />
    </div>
  );
}
