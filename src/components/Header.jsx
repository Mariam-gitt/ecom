...
import { ShoppingCart, Heart, Sun, Moon, LayoutDashboard } from "lucide-react";
    ...
    <header className="sticky top-0 z-10 bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800 transition-colors">
      <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-3">
          ...
          {/* Deliberately unlabeled/low-key — this is a link to the
              password-gated admin dashboard (see AdminPage.jsx),
              not something a regular shopper needs to notice or use. */}
          <Link
            to="/admin"
            title="Admin dashboard"
            className="w-9 h-9 flex items-center justify-center rounded-full border border-neutral-200 dark:border-neutral-700 dark:text-white text-neutral-400"
          >
