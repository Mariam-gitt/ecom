...
export default function CheckoutForm() {
  ...
  if (submitted) {
    ...
    return (
      <div className="bg-white border border-neutral-200 rounded-xl p-6 text-center">
        <p className="text-sm font-medium mb-1">Thanks, {formData.name}!</p>
  ...
  return (
    <form
      ...
      className="bg-white border border-neutral-200 rounded-xl p-6 space-y-3"
    >
      <p className="text-sm font-medium">Checkout details</p>
      <div>
        <input
          name="name"
      ...
      <button
        type="submit"
        className="w-full bg-neutral-900 text-white text-sm py-2 rounded-lg hover:bg-neutral-700 transition-colors"
      >
        Place order
      </button>
    </form>
